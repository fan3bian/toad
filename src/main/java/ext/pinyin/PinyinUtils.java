...
public class PinyinUtils {
    ...
    private static final Logger LOG = LogManager.getLogger(PinyinUtils.class);
    //测试数据
    ...
    public static void main(String[] args) {
        ...
        String alpha = getAlpha(TESTDATA);
        System.out.println("获得汉语拼音首字母(大写拼音首字母)：>>>"+alpha);

        String pingYin = getPingYin(TESTDATA);
        System.out.println("将字符串中的中文转化为拼音,英文字符不变：>>>"+pingYin);

        String toFirstSpell = converterToFirstSpell(TESTDATA);
        System.out.println("汉字转换为汉语拼音首字母，英文字符不变：>>>"+toFirstSpell);
